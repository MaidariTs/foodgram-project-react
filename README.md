...
git push
```
запускается набор блоков команд jobs (https://github.com/MaidariTs/foodgram-project-react/blob/master/.github/workflows/foodgram_workflow.yml), т.к. команда `git push` является триггером workflow проекта.  
...
## Об авторе
[Maidari Tsydenov](https://github.com/MaidariTs/)
